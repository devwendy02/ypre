    ...
    [764], {
        48764: function(t, r, e) {
            ...
            function s(t, r, e) {
                ...
                if (O(t, ArrayBuffer) || t && O(t.buffer, ArrayBuffer) || "undefined" != typeof SharedArrayBuffer && (O(t, SharedArrayBuffer) || t && O(t.buffer, SharedArrayBuffer))) return l(t, r, e);
            ...
            function b(t, r, e, n, i) {
                ...
                if ("string" == typeof e ? (n = e, e = 0) : e > 2147483647 ? e = 2147483647 : e < -2147483648 && (e = -2147483648), (o = e = +e) != o && (e = i ? 0 : t.length - 1), e < 0 && (e = t.length + e), e >= t.length) {
                    if (i) return -1;
                    e = t.length - 1
                } else if (e < 0) {
                    if (!i) return -1;
                ...
                if ("string" == typeof r && (r = u.from(r, n)), u.isBuffer(r)) return 0 === r.length ? -1 : v(t, r, e, n, i);
                if ("number" == typeof r) return (r &= 255, "function" == typeof Uint8Array.prototype.indexOf) ? i ? Uint8Array.prototype.indexOf.call(t, r, e) : Uint8Array.prototype.lastIndexOf.call(t, r, e) : v(t, [r], e, n, i);
            ...
            function A(t, r, e, n, o) {
                return r = +r, e >>>= 0, o || B(t, r, e, 4, 34028234663852886e22, -34028234663852886e22), i.write(t, r, e, n, 23, 4), e + 4
            }

            function U(t, r, e, n, o) {
                return r = +r, e >>>= 0, o || B(t, r, e, 8, 17976931348623157e292, -17976931348623157e292), i.write(t, r, e, n, 52, 8), e + 8
            }
            r.Buffer = u, r.SlowBuffer = function(t) {
                ...
                for (e = 0; e < t.length; ++e) {
                    var o = t[e];
                    if (O(o, Uint8Array)) i + o.length > n.length ? u.from(o).copy(n, i) : Uint8Array.prototype.set.call(n, o, i);
            ...
            }, o && (u.prototype[o] = u.prototype.inspect), u.prototype.compare = function(t, r, e, n, i) {
                ...
                for (var o = i - n, f = e - r, s = Math.min(o, f), h = this.slice(n, i), a = t.slice(r, e), p = 0; p < s; ++p)
                    if (h[p] !== a[p]) {
                        o = h[p], f = a[p];
                        break
                    }
                ...
                var i, o, f, u, s, h, a, p, l = this.length - r;
                ...
                for (var c = !1;;) switch (n) {
                    ...
                    case "utf8":
                    case "utf-8":
                        return i = r, o = e, S(I(t, this.length - i), this, i, o);
                    case "ascii":
                    case "latin1":
                    case "binary":
                        return f = r, u = e, S(function(t) {
                            for (var r = [], e = 0; e < t.length; ++e) r.push(255 & t.charCodeAt(e));
                            return r
                        }(t), this, f, u);
                    case "base64":
                        return s = r, h = e, S(L(t), this, s, h);
                    case "ucs2":
                    case "ucs-2":
                    case "utf16le":
                    case "utf-16le":
                ...
                return (t >>>= 0, r || E(t, 1, this.length), 128 & this[t]) ? -((255 - this[t] + 1) * 1) : this[t]
                ...
                return t >>>= 0, r || E(t, 4, this.length), i.read(this, t, !0, 23, 4)
            }, u.prototype.readFloatBE = function(t, r) {
                return t >>>= 0, r || E(t, 4, this.length), i.read(this, t, !1, 23, 4)
            }, u.prototype.readDoubleLE = function(t, r) {
                return t >>>= 0, r || E(t, 8, this.length), i.read(this, t, !0, 52, 8)
            }, u.prototype.readDoubleBE = function(t, r) {
                return t >>>= 0, r || E(t, 8, this.length), i.read(this, t, !1, 52, 8)
